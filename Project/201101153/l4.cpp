...
if(level==3)
{
if(	(lookx < -1.8 && lookx > -8.4 && lookz > -6.6 )
		||
	(lookx < 3 && lookx > -3 && lookz < -8.4 && lookz > -15.2 )
		||
	(lookx < 11.5 && lookx > 5.3 && lookz < -12.6 && lookz > -15.2 )
		||
	(lookx < -3 && lookx > -9.6 && lookz < -11.3 && lookz > -18 )
		)
{
	fall=1;
	printf("yahan\n");
...
if(	//(lookx < -1.8 && lookx > -8.4 && lookz > -6.6 )
	//	||
	(lookx2 < 3 && lookx2 > -3 && lookz2 < -8.4 && lookz2 > -15.2 )
		||
	(lookx2 < 11.5 && lookx2 > 5.3 && lookz2 < -12.6 && lookz2 > -15.2 )
		||
	(lookx2 < -3 && lookx2 > -9.6 && lookz2 < -11.3 && lookz2 > -18 )
		)
{
//	fall=1;
	fall2=1;
...
/*
if(level==3 && lookx < -1.7 && lookx > -8.4 && lookz < -6.0 && lookz > -6.6 )
{
	fall=1;
}
*/	
...
if(level==3 && lookx < 10 && lookx >-10 && lookz < -30 && lookz > -40)
	...
	glPushMatrix();
		...
		glScalef(1, 1, 1);
		glTranslatef(vtr.x+2, vtr.y+10, vtr.z);
...
if(counter1 < 11)
	...
	if(pause1%2==0){
		...
		if(fall==1 && win==0 && level!=3){go_y-=0.1f;}
